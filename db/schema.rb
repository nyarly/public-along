...
ActiveRecord::Schema.define(version: 20170627215136) do
  ...
  create_table "emp_deltas", force: :cascade do |t|
    t.integer  "employee_id"
    t.hstore   "before"
    t.hstore   "after"
    t.datetime "created_at",  null: false
  ...
  add_foreign_key "emp_deltas", "employees", on_delete: :cascade
