class SecurityProfile < ActiveRecord::Base
  ...
  has_many :departments, through: :dept_sec_profs, dependent: :destroy
  has_many :sec_prof_access_levels
  has_many :access_levels, through: :sec_prof_access_levels, dependent: :destroy
  has_many :emp_sec_profiles
  has_many :emp_transactions, through: :emp_sec_profiles, dependent: :destroy
