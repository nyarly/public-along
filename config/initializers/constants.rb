...
OUS = {
  ...
  "ou=UK Sales,ou=EU," => { :department => ["OT Sales - General", "OT Sales Operations", "OT Inside Sales", "OT Restaurant Relations Management"], :country => ["GB"] },
  "ou=DE Sales,ou=EU," => { :department => ["OT Sales - General", "OT Sales Operations", "OT Inside Sales", "OT Restaurant Relations Management"], :country => ["DE"] },
  ...
  "ou=IT," => { :department => ["OT IT Technical Services and Helpdesk", "OT IT - Engineering", "OT Data Center Ops"], :country => ["US", "IN"] },
  "ou=IT,ou=EU," => { :department => ["OT IT Technical Services and Helpdesk", "OT IT - Engineering", "OT Data Center Ops"], :country => ["GB"] },
  ...
  "ou=Legal," => { :department => ["OT Legal", "OT Risk Management and Fraud"], :country => ["US"] },
...
COST_CENTERS ={
  ...
  "000011" =>  "OT People and Culture",
  "000012" =>  "OT Legal",
  "000013" =>  "OT Finance",
  "000014" =>  "OT Risk Management and Fraud",
  ...
  "000035" =>  "OT IT Technical Services and Helpdesk",
...
LOCATIONS = {
  "OT San Francisco" => "Office",
  "OT Los Angeles" => "Office",
  "OT Denver" => "Office",
  "OT Chattanooga" => "Office",
  "OT Chicago" => "Office",
  "OT New York" => "Office",
  "OT Mexico City" => "Office",
  "OT London" => "Office",
  "OT Frankfurt" => "Office",
  "OT Mumbai" => "Office",
  "OT Mumbai" => "Office",
  "OT Tokyo" => "Office",
  "OT Melbourne" => "Office",
  "OT Arizona" => "Remote Location",
  "OT Illinois" => "Remote Location",
  "OT Tennessee" => "Remote Location",
  "OT Southern CA" => "Remote Location",
  "OT Minnesota" => "Remote Location",
  "OT Maine" => "Remote Location",
  "OT Georgia" => "Remote Location",
  "OT Canada" => "Remote Location",
  "OT Washington DC" => "Remote Location",
  "OT Pennsylvania" => "Remote Location",
  "OT Oregon" => "Remote Location",
  "OT Wisconsin" => "Remote Location",
  "OT Texas" => "Remote Location",
  "OT Ohio" => "Remote Location",
  "OT Massachusetts" => "Remote Location",
  "OT Washington" => "Remote Location",
  "OT Florida" => "Remote Location",
  "OT Nevada" => "Remote Location",
  "OT New Jersey" => "Remote Location",
  "OT Hawaii" => "Remote Location",
  "OT Vermont" => "Remote Location",
  "OT Missouri" => "Remote Location",
  "OT Louisiana" => "Remote Location",
  "OT Michigan" => "Remote Location",
  "OT Ireland" => "Remote Location",
  "OT North Carolina" => "Remote Location",
  "OT Idaho" => "Remote Location",
  "OT Maryland" => "Remote Location",
  "OT Utah" => "Remote Location",
  "OT Kentucky" => "Remote Location"
}
