...
describe SabaService, type: :service do
  ...
  describe "create_person_csv" do
    ...
    # let(:emp1) { profile_1.employee, profile_1.employee.email = "test1@opentable.com" }
    ...
    #   department_id: dept.id,
    #   company: "OpenTable, Inc.")}
    #     let(:emp3) { profile_3.employee }

    # let!(:emp4) {FactoryGirl.create(:pending_employee,
    ...
    #   department_id: dept.id,
    #   company: "OpenTable, Inc.")}
    # let(:emp4) { profile_4.employee }

    # let!(:experiment) { FactoryGirl.create(:active_employee, first_name: "AAHHHHHH", profile_args: { business_title: "monster" })}
    let!(:experiment) { FactoryGirl.create(:profile)}
    # FactoryGirl.create(:profile, profile_args: {email: "test@test.com"})
