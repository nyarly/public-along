...
describe ConcurImporter::EmployeeDetail, type: :service do
  describe '#all' do
    ...
    context 'when manager' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(manager).all }
    ...
    context 'when terminated' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(termed_worker).all }
    ...
    context 'when us office worker' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(us_position.employee).all }
    ...
    context 'when uk worker' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(uk_position.employee).all }
    ...
    context 'when canadian worker' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(canadian.employee).all }
    ...
    context 'when other international worker' do
      subject(:detail) { ConcurImporter::EmployeeDetail.new(intl_position.employee).all }
