...
describe SummaryReportHelper, type: :helper do
  ...
  context "job change" do
    ...
    let(:csv) {
      ...
      A_org,A_dept,#{emp_3.current_profile.adp_employee_id},#{emp_3.first_name},#{emp_3.last_name},#{emp_3.job_title.name},,#{emp_3.location.name},"#{emp_3.current_profile.start_date.strftime("%b %e, %Y")}",Manager,#{old_manager.cn},#{manager.cn},"#{emp_delta_3.created_at.try(:strftime, "%b %e, %Y at %H:%M:%S")}",#{emp_3.worker_type.name}
      ...
      A_org,A_dept,#{emp_3.current_profile.adp_employee_id},#{emp_3.first_name},#{emp_3.last_name},#{emp_3.job_title.name},,#{emp_3.location.name},"#{emp_3.current_profile.start_date.strftime("%b %e, %Y")}",Manager Employee ID,#{old_manager.current_profile.adp_employee_id},#{manager.current_profile.adp_employee_id},"#{emp_delta_3.created_at.try(:strftime, "%b %e, %Y at %H:%M:%S")}",#{emp_3.worker_type.name}
